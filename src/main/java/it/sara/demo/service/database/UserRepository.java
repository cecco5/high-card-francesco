 ...
 *
 * <p>Provides methods for retrieving and saving user entities. Currently uses {@code FakeDatabase}
 * (in-memory list), but designed for easy migration to a real database (e.g., JPA repository).
 */
@Component
public class UserRepository {

  /**
   * Saves a new user to the database. Automatically generates and assigns a unique GUID to the
   * user.
   *
